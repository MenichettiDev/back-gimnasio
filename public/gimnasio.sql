...
-- Tiempo de generación: 07-02-2025 a las 03:15:46
...
--
-- Volcado de datos para la tabla `tb_ejercicios`
--
...
--
-- Estructura de tabla para la tabla `tb_entrenador`
--
...
--
-- Volcado de datos para la tabla `tb_entrenador`
--
...
--
-- Estructura de tabla para la tabla `tb_entrenador_gimnasio`
--
...
--
-- Volcado de datos para la tabla `tb_entrenador_gimnasio`
--
...
--
-- Estructura de tabla para la tabla `tb_frases`
--
...
--
-- Volcado de datos para la tabla `tb_frases`
--

INSERT INTO `tb_frases` (`id_frase`, `frase`) VALUES
(1, 'Desarrolla el super poder de hacer un poco cada día'),
(2, 'Cuando tu cuerpo está sano, tienes miles de problemas. Cuando enfermas, tienes un solo problema.'),
(3, 'Lo que no estás cambiando, lo estás eligiendo'),
(4, 'Si crees que es cara la factura de haber fallado, espera a que te llegue la factura de ni siquiera haberlo intentado'),
(5, 'No podemos controlar las dificultades, pero sí cómo respondemos ante ellas'),
(6, 'Enfoca tu energía en lo que puedes cambiar, en vez de desperdiciarla en lo que está fuera de tu control'),
(7, '¿Acaso no dijiste... Libranos de todo mal..?'),
(8, 'Si se te nota el gym, ¡y te está quedando rico!'),
(9, 'El pensamiento condiciona la acción. La acción determina el comportamiento. El comportamiento repetido crea hábitos. El hábito estructura el carácter (la manera de pensar, ser y actuar de un individuo'),
(10, 'Tu actitud es la vela de tu barco'),
(11, 'El fracaso no es cuando caemos, es cuando nos rehusamos a levantarnos'),
(12, 'No bajes tus sueños a la capacidad de tus habilidades aparentes, haz que estas suban a la altura de tus sueños'),
(13, '¿Quién decide si eres N°1 o no? Tú'),
(14, 'Quiza, luego sea hoy'),
(15, 'Ganar depende exclusivamente de vos'),
(16, 'Te han jodido, pero esto no ha terminado'),
(17, 'Disciplina, el valor más fuerte'),
(18, 'Si quieres rendirte, puedes rendirte. Es tu elección... Pero si eliges no rendirte, eso es algo de lo que estar orgulloso'),
(19, 'Sé realista, sal a buscarlo, si no sabes hacerlo, busca el ejemplo... Haz tu plan'),
(20, 'Sueña en grande, actúa en pequeño'),
(21, 'La única razón por la que no estás viviendo la vida que quieres vivir, es porque TU día a día sigues alimentando la vida que no quieres vivir'),
(22, 'La excelencia no aparece sin exigencia, eres tú vs tú'),
(23, 'Los resultados en la vida son consecuencia de lo que hemos hecho, es decir, que estás sembrando tu futuro'),
(24, 'No hay truco, eres tú vs tú'),
(25, 'Si no te gusta lo que cosechas, cambia lo que siembras'),
(26, 'Disciplina tus pensamientos, deja de sobrepensar, no vayas al pasado, no vayas al futuro, quédate en el presente'),
(27, 'No temas una tormenta, aprende a bailar bajo la lluvia'),
(28, 'Apaga el celular'),
(29, '¿Por qué ser normal, si puedes ser mejor?'),
(30, 'Si puedes verlo, y tienes el coraje de manifestarlo, sucederá'),
(31, 'Nunca digas que no puedes hacerlo, di que aún no lo has hecho'),
(32, 'Disciplina es hacer lo que odias hacer, pero haciéndolo como si te encantara'),
(33, 'La magia que buscas, está en el trabajo que estás evitando'),
(34, 'Algunas cosas tienen que terminar, para que vengan cosas mejores'),
(35, '¿Qué tan grande soñarías, si supieras que no puedes fracasar?'),
(36, 'Eres tú, en tu forma de tratarte cuando te caes, el que determina si has caído en un bache o en una tumba'),
(37, 'Es mejor ser un guerrero en un jardín, que un jardinero en una guerra'),
(38, 'Pregúntate al final de cada día si lo hiciste bien. Si la respuesta es sí, dentro de 5 o 10 años, ¿hasta qué punto habrás mejorado?');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tb_gimnasio`
--
...
--
-- Volcado de datos para la tabla `tb_gimnasio`
--
...
--
-- Estructura de tabla para la tabla `tb_grupos_musculares`
--
...
--
-- Volcado de datos para la tabla `tb_grupos_musculares`
--
...
--
-- Estructura de tabla para la tabla `tb_logros`
--
...
--
-- Volcado de datos para la tabla `tb_logros`
--
...
--
-- Estructura de tabla para la tabla `tb_membresia`
--
...
--
-- Volcado de datos para la tabla `tb_membresia`
--
...
(35, 'Coach', '-', '/ejercicios/coach', 'GM04', 0, 4, 1, '-'),
(36, 'Editar Ejercicio', '-', '/ejercicios/editar-ejercicio', 'GM04', 0, 3, 1, '-'),
(37, '', '-', '/', 'GM04', 0, 5, 0, '-'),
(38, '', '-', '/', 'GM04', 0, 6, 0, '-'),
(39, '', '-', '/', 'GM04', 0, 7, 0, '-'),
(40, '', '-', '/', 'GM04', 0, 8, 0, '-'),
...
--
-- Estructura de tabla para la tabla `tb_menu_perfil`
--
...
--
-- Volcado de datos para la tabla `tb_menu_perfil`
--
...
--
-- Estructura de tabla para la tabla `tb_nivel_dificultad`
--
...
--
-- Estructura de tabla para la tabla `tb_objetivo`
--
...
--
-- Estructura de tabla para la tabla `tb_repeticion`
--
...
--
-- Volcado de datos para la tabla `tb_repeticion`
--
...
--
-- Estructura de tabla para la tabla `tb_rutina`
--
...
--
-- Volcado de datos para la tabla `tb_rutina`
--
...
(8, 1, 'prueba', '2', 'Principiante', 'Tonificacion', 'test');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tb_rutina_atleta`
--
...
--
-- Volcado de datos para la tabla `tb_rutina_atleta`
--
...
--
-- Estructura de tabla para la tabla `tb_rutina_ejercicios`
--
...
--
-- Volcado de datos para la tabla `tb_rutina_ejercicios`
--

INSERT INTO `tb_rutina_ejercicios` (`id_rutina_ejercicios`, `id_rutina`, `id_ejercicios`, `id_repeticion`, `id_grupo_muscular`, `dia`) VALUES
(16, 8, 123, 13, 11, '1'),
(17, 8, 55, 9, 5, '2');
...
--
-- Estructura de tabla para la tabla `tb_rutina_favorita`
--
...
--
-- Volcado de datos para la tabla `tb_rutina_favorita`
--
...
--
-- Indices de la tabla `tb_ejercicios`
--
...
--
-- Indices de la tabla `tb_entrenador`
--
...
--
-- Indices de la tabla `tb_membresia`
--
...
--
-- Indices de la tabla `tb_menu_perfil`
--
...
--
-- Indices de la tabla `tb_nivel_dificultad`
--
ALTER TABLE `tb_nivel_dificultad`
  ADD PRIMARY KEY (`id_nivel`);

--
-- Indices de la tabla `tb_objetivo`
--
...
--
-- Indices de la tabla `tb_repeticion`
--
ALTER TABLE `tb_repeticion`
  ADD PRIMARY KEY (`id_repeticion`);

--
-- Indices de la tabla `tb_rutina`
--
...
--
-- Indices de la tabla `tb_rutina_atleta`
--
...
--
-- Indices de la tabla `tb_rutina_ejercicios`
--
...
--
-- Indices de la tabla `tb_rutina_favorita`
--
...
--
-- AUTO_INCREMENT de la tabla `tb_ejercicios`
--
ALTER TABLE `tb_ejercicios`
  MODIFY `id_ejercicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;

--
-- AUTO_INCREMENT de la tabla `tb_entrenador`
--
ALTER TABLE `tb_entrenador`
  MODIFY `id_entrenador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `tb_frases`
--
ALTER TABLE `tb_frases`
  MODIFY `id_frase` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT de la tabla `tb_gimnasio`
--
ALTER TABLE `tb_gimnasio`
  MODIFY `id_gimnasio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `tb_grupos_musculares`
--
ALTER TABLE `tb_grupos_musculares`
  MODIFY `id_grupo_muscular` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `tb_logros`
--
ALTER TABLE `tb_logros`
  MODIFY `id_logro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `tb_membresia`
--
ALTER TABLE `tb_membresia`
...
--
-- AUTO_INCREMENT de la tabla `tb_menu_perfil`
--
ALTER TABLE `tb_menu_perfil`
...
--
-- AUTO_INCREMENT de la tabla `tb_nivel_dificultad`
--
ALTER TABLE `tb_nivel_dificultad`
  MODIFY `id_nivel` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tb_objetivo`
--
ALTER TABLE `tb_objetivo`
...
--
-- AUTO_INCREMENT de la tabla `tb_repeticion`
--
ALTER TABLE `tb_repeticion`
  MODIFY `id_repeticion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `tb_rutina`
--
ALTER TABLE `tb_rutina`
  MODIFY `id_rutina` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `tb_rutina_atleta`
--
ALTER TABLE `tb_rutina_atleta`
  MODIFY `id_rutina_atleta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `tb_rutina_ejercicios`
--
ALTER TABLE `tb_rutina_ejercicios`
  MODIFY `id_rutina_ejercicios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
-- Filtros para la tabla `tb_atleta`
--
ALTER TABLE `tb_atleta`
...
--
-- Filtros para la tabla `tb_ejercicios`
--
ALTER TABLE `tb_ejercicios`
...
--
-- Filtros para la tabla `tb_rutina_ejercicios`
--
ALTER TABLE `tb_rutina_ejercicios`
  ...
  ADD CONSTRAINT `tb_rutina_ejercicios_ibfk_4` FOREIGN KEY (`id_grupo_muscular`) REFERENCES `tb_grupos_musculares` (`id_grupo_muscular`);

--
-- Filtros para la tabla `tb_rutina_favorita`
--
ALTER TABLE `tb_rutina_favorita`
